...
type Props = {
  ...
  updateSettlementBatch: (id: string, updates: Partial<Pick<SettlementBatch, 'adjustment' | 'invoiceDate' | 'dueDate' | 'notes' | 'status'>>) => void;
